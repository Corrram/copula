...
and as θ→∞ tends to Marshall–Olkin. These identifications require proofs,
not evaluation at an infinite real parameter. The t-EV limiting-case column
