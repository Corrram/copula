...
| A03 | Ali–Mikhail–Haq | −1 ≤ θ ≤ 1 | `P/(1−θ(1−u)(1−v))` | `amh`; full-square `cdf_amh`; CI/PQD and CDF TP2 iff θ≥0, CD/NQD iff θ≤0; MTP2 density proved at θ=0,1 and excluded for θ<0; exact lower-orthant parameter order and tail pair including θ=1 |
