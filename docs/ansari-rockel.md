...
| A08 | Nelsen 8 | θ ≥ 1 | `((θ²P−(1−u)(1−v))/(θ²−(θ−1)²(1−u)(1−v)))₊` | `nelsen8`; `nelsen8_cdf_full`; `nelsen8_one` |
...
[Nelsen8.lean](../Copula/Families/Nelsen8.lean) proves A08's rational generator, printed CDF on the full closed square, and θ=1 lower-Fréchet endpoint. Its dependence, ordering, tail, and coefficient cells remain separate obligations.
