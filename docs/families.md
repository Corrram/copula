...
| Nelsen 12 | `nelsen12 θ hθ` | `θ ≥ 1` | 2 | `nelsen12_cdf_full` on the closed square; Clayton at one and pointwise comonotonicity as θ→∞; increasing lower-orthant order; exact lower/upper tail coefficients; CI, CDF TP2, MTP2 density and non-CD at θ=1 |
| Nelsen 14 | `nelsen14 θ hθ` | `θ ≥ 1` | 2 | `nelsen14_cdf_full` on the closed square; Clayton at one; pointwise comonotonicity as θ→∞; exact lower/upper tail coefficients 1/2 and 2−2^(1/θ); CI, CDF TP2, MTP2 density and non-CD at θ=1 |
