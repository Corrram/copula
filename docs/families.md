...
| Genest–Ghoudi / Nelsen 15 | `genestGhoudi θ hθ` | `θ ≥ 1` | 2 | `genestGhoudi_cdf_full` on the closed square; lower bound at 1; exact lower/upper tail coefficients 0 and 2−2^(1/θ); never CI or TP2; CD iff θ=1 |
