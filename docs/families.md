...
| Ali–Mikhail–Haq | `amh θ hmin hmax` | `−1 ≤ θ ≤ 1` | 2 | `cdf_amh` proves `uv/(1−θ(1−u)(1−v))` on the closed square; at θ=1 this is Clayton(1); CI/PQD and CDF TP2 iff θ≥0, CD/NQD iff θ≤0; lower-orthant order iff θ≤η; tail pair (0,0) below θ=1 and (1/2,0) at θ=1 |
