...
| Nelsen 8 | `nelsen8 θ hθ` | `θ ≥ 1` | 2 | `nelsen8_cdf_full` proves the printed rational CDF on the closed square; `θ = 1` is W; exact tail pair (0,0); increasing lower-orthant order |
