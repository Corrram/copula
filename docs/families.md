...
| Ali–Mikhail–Haq | `amh θ hmin hmax` | `−1 ≤ θ ≤ 1` | 2 | `cdf_amh` proves `uv/(1−θ(1−u)(1−v))` on the closed square; at θ=1 this is Clayton(1); PQD iff θ≥0 and NQD iff θ≤0; tail pair (0,0) below θ=1 and (1/2,0) at θ=1 |
