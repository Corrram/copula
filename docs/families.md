...
| Nelsen 2 | `nelsen2 θ hθ` | `θ ≥ 1` | 2 | `nelsen2_cdf_full` on the closed square; lower bound at 1; exact tail pair `(0,2−2^(1/θ))`; non-PQD/non-CI and no CDF TP2 or MTP2 density; CD exactly at θ=1 |
