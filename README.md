...
| `Copula.Dependence.NelsenEndpoints` | At θ=1, Nelsen 12 and 14 are CI, CDF TP2, MTP2-density by their Clayton(1) identity; both are non-CD for all θ≥1, and both are PQD for all θ≥1 |
